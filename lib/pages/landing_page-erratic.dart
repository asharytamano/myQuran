...
class LandingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Maranaw Tafsir App"),
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "Deepen your connection to the Qur'an with this app, featuring AbuAhmad Tamano's Maranaw translation and tafsir. Listen to your favorite reciters, save verses to Favorites, and easily share them for study or on social media.",
                  textAlign: TextAlign.center,
                  style: GoogleFonts.merriweather(
                    fontSize: 14,
                    color: Colors.white,
