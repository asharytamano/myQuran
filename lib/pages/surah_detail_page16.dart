...
class _SurahDetailPageState extends State<SurahDetailPage> {
      ...
      if (currentlyPlayingAyah != null) {
        if (repeatAyah) {
          ...
          if (next < ayahs.length) {
            ...
            _showSnackMessage("End of Surah");
          }
        } else {
          setState(() => isPlaying = false);
        }
  ...
  void _showSnackMessage(String message) async {
    // 🔔 Play chime sound
    try {
      await _audioPlayer.play(AssetSource('sounds/bell-chime.mp3'));
    } catch (e) {
      debugPrint("Chime sound error: $e");
    }

    // 🟢 Floating Snackbar above pagination
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          message,
        ...
        margin: const EdgeInsets.only(
          bottom: 80, // 👈 lifts above pagination controls
          left: 16,
          right: 16,
        ),
                ...
                children: [
                  IconButton(
                    ...
                    onPressed: currentPage > 0
                      ...
                      _showSnackMessage("Start of Surah");
                    }
                        : null,
                  ),
                  Text(
